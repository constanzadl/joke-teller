...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '88e2120fcc8f484aa77a56d25d7081ed',
        src: joke,
        hl: 'en-gb',
        v: 'Alice',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiURL = 'https://sv443.net/jokeapi/v2/joke/Any?blacklistFlags=nsfw,religious,political,racist,sexist&idRange=0-185';
    try {
        ...
        //Catch error
        console.log('Joke not found: ', err);
    }
}
